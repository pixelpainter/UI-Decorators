UI Decorators is a set of 4 nodes to enhance frontside SubGraph usability and organization.<br/>
...
A node with a Note widget which can be added to the front of the SubGraph node. The Note has editable font size, an option to bold the text, and a color picker for the background color, and the font color, or simnply change the colors using hex values.
